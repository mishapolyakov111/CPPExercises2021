...
//    std::cout << TODO << "/" << TODO << " good matches left" << std::endl;
    ...
    cv::warpPerspective(img2,img1to0,H10,img0.size()); // сделайте то же самое что и в предыдущей визуализации но вместо второй картинки - наложите картинку с несквиком
